...
{
    public abstract class ColorSelectionPanel : Menu
    {
        #region vars
        ...
        protected ColorSelectionGrid selector;
        ...
        public ColorSelectionPanel(int positionX, int positionY, int _width, int _height, int itemWidth, int itemHeight, int _scale, Action[] buttonEvents, Texture2D uiTexture, Texture2D lineTexture, SpriteFont _font, InputHandler _input) : base(positionX, positionY, _width, _height, _scale, uiTexture, lineTexture, _font, _input)
        {
            font = _font;
        ...
        public void LoadItem(int itemID, string itemName, Color newColor)
        {
            selector.InsertItem(itemID, itemName, newColor);
        }
